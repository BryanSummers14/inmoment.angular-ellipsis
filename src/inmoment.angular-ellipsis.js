/**
 * 	This is shamelessly stolen from https://github.com/dibari/angular-ellipsis who deserves all the credit
 * 	However, we needed to add animation to prevent initial overflow from showing on our internal application
 *	
...
.directive('ellipsis', ['$timeout', '$window', '$sce', function($timeout, $window, $sce) {
	...
	var asyncDigestDebounced = new AsyncDigest(125);
		...
		compile: function(elem, attr, linker) {
			...
			return function(scope, element, attributes) {
				...
				function buildEllipsis() {
					...
					// if jquery is available then animate, otherwise just show the element
					if(angular.isDefined(element.animate)) {
						element.animate({opacity: 1}, 1050);
					}else {
